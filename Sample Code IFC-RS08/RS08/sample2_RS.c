...
//	Project description	:Sample2 for IFC-RS08
//						  8 servos will rotate continues left to right and vice versa without servo position reporting command 
//  Date				: 2 March 2009
//
//=====================================================================================
...
void main(void)
{
	unsigned int position_a,speed_a,speed_b;
	//--------------------------------------------------------------------------------
	...
	{	
		...
		else if(sw2==0)					//servo will only rotate after the sw1 at Main Board is pressed
		{
			...
			{									//servo motors will not run if sw1 is not press before this
				...
				delay(500000);						//delay some times to waite for servos reach its position
				...
				delay(2000000);						//delay some times to waite for servos reach its position
			}
		}
	}	//while loop
